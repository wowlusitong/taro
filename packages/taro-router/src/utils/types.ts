...
export type PageComponent = new (props: any, context: any) => Component<any, any>
...
export namespace History {
  ...
  export type LocationListener = (opts: { fromLocation: Location; toLocation: Location; action: Action }) => void
